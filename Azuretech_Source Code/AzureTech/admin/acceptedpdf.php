<?php
    ...
    $pdf->SetTitle("Accepted Orders Report");  
    ...
    $pdf->AddPage();  
		...
		$html = <<<EOD
		<h3 align="center">Water Refilling Station</h3><h3 align="center">Accepted Orders Report</h3> <p align="center">Report from $m1-$d1-$y1 to  $m2-$d1-$y2</p><p></p>
		EOD;
    ...
    $pdf->Output('Accepted Orders Report.pdf', 'I');
