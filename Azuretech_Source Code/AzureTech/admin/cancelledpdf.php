<?php
    ...
    $pdf->SetTitle("Cancelled Orders Report");  
    ...
    $pdf->AddPage();  
		...
		$html = <<<EOD
		<h3 align="center">Water Refilling Station</h3><h3 align="center">Cancelled Orders Report</h3> <p align="center">Report from $m1-$d1-$y1 to  $m2-$d1-$y2</p><p></p>
		EOD;
    ...
    $pdf->Output('Cancelled Orders Report.pdf', 'I');
