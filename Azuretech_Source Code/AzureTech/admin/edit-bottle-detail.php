...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i><a href="manage-bottle.php">Manage Products</a><i class="fa fa-angle-right"></i>Update Water Bottle
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
?>		
								<div class="form-group">
									<label for="smallinput" class="col-sm-2 control-label">Water Type</label>
									<div class="col-sm-8">
									<select class="col-sm-12 form-control" name="compname" id="compname" required="true" style="width:30em;">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<select class="col-sm-12 form-control" name="bottlesize" id="bottlesize" required="true" style="width:30em;">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="price" id="price" value="<?php echo $row['Price'];?>" required='true' style="width:30em;">
									</div>
								</div>
