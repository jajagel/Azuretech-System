  	       ...
  	       <h3>Admin Profile</h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							...
							<p style="font-size:16px; color:#408140" align="center"> <?php if($msg){
    echo $msg;
  }  ?> </p>
  <?php
$adminid=$_SESSION['wsmsaid'];
...
?>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input style="width: 30em;" type="text" name="adminname" id="adminname" class="form-control" value="<?php  echo $row['AdminName'];?>" required='true'>
									</div>
								</div>
								<div class="form-group">
									<label for="mediuminput" class="col-sm-2 control-label">User Name</label>
									<div class="col-sm-8">
										<input style="width: 30em;" type="text" class="form-control" name="username" id="username" value="<?php  echo $row['UserName'];?>">
									</div>
								</div>
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Contact Number</label>
									<div class="col-sm-8">
										<input style="width: 30em;" type="text" class="form-control" id="contactnumber" name="contactnumber" value="<?php  echo $row['MobileNumber'];?>" required='true' maxlength='11' pattern='[0-9]+'>
									</div>
								</div>
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Email address</label>
									<div class="col-sm-8">
										<input style="width: 30em;" type="email" id="email" name="email" class="form-control" value="<?php  echo $row['Email'];?>">
									</div>
								</div>
