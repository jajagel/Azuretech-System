<?php
    ...
    $pdf->AddPage();  
		...
		$html = <<<EOD
		<h3 align="center">Water Refilling Station</h3><h3 align="center">Monthly Sales Report</h3> <p align="center">Report from $m1-$y1 to $m2-$y2</p><p></p>
		EOD;
    ...
    $pdf->Output('Monthly Sales report.pdf', 'I');
