...
?>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input style="width: 30em;" type="password" name="currentpassword" id="currentpassword" class="form-control" value="" required='true'>
									</div>
								</div>
								<div class="form-group">
									<label for="mediuminput" class="col-sm-2 control-label">New Password</label>
									<div class="col-sm-8">
										<input style="width: 30em;" type="password" name="newpassword" id="newpassword" class="form-control" value="" required='true'>
									</div>
								</div>
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg">Confirm Password</label>
									<div class="col-sm-8">
										<input style="width: 30em;" type="password" name="confirmpassword" id="confirmpassword" class="form-control" value="" required='true'>
									</div>
								</div>
