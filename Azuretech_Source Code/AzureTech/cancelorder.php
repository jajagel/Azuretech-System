...
<td>    <textarea name="restremark" placeholder="" rows="5" cols="50" class="form-control wd-450" required="true"></textarea></td>
        </tr>
<tr>
...
<?php } else { ?>
  <p style="color:red; font-size:20px;"> Unable to cancel. Order is already accepted.</p>
