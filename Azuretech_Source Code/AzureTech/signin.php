			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						...
						<div class="section_title"><h2>Sign In</h2></div>-->
					</div>
				</div>
			</div>
				...
				<div class="col">
					<div class="contact_form_container">
						<form action="#" class="contact_form text-center" id="contact_form" method="post" name="signup">
							<p class="mb-2" style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
  }  ?> </p>
							<div class="row">
								<div class="col-lg-12">
									<input type="text" class="form-control" placeholder="Email or Contact Number" name="emailcont" id="email" required="true">
								</div>
			...
			<!--<a href="forgot-password.php" style="margin-left:2%; margin-top:1%">Forgot Password?</a>-->
							...
							<button class="contact_button btn btn-primary" type="submit" name="login">Submit</button>
							<div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted mt-2">Don't have an account?  <a href="signup.php" class="text-dark m-l-5"><b>Sign Up</b></a></p>
                                </div>
                            </div>
						</form>
					</div>
